...
<form method="post" id="create_customer">
	...
	<div class="row">
		<div class="col-xs-12 margin-top btn-group">
			<!-- <input type="submit" id="action_create_customer custom-btn" class="btn btn-success float-right" value="Create Customer" data-loading-text="Creating..."> -->
			<input type="submit" id="action_create_customer" class="btn btn-success custom-btn float-right" value="Create Customer" data-loading-text="Creating...">
