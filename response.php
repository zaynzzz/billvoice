...
if ($action == 'email_invoice') {
    ...
    $emailId = $_POST['email']; // Ambil email penerima
    $invoice_data = $_POST['invoice_data']; // Data invoice yang akan ditampilkan (misalnya total, tanggal, dll.)
    ...
    // Susun email dengan HTML untuk menyerupai PDF
    $htmlContent = '
        <html>
        <head>
            <style>
                    ...
                    <tr class="top">
                        <td colspan="2">
                            <table>
                                <tr>
                                    <td class="title">
                                        <img src="https://yourwebsite.com/logo.png" style="width:100%; max-width:300px;">
                                    </td>
                                    
                                    <td>
                                        Invoice #: 123<br>
                                        Created: ' . date('M d, Y') . '<br>
                                        Due: ' . date('M d, Y', strtotime('+30 days')) . '
                                    </td>
                                </tr>
                            </table>
                        </td>
    ...
    $mail->AltBody = 'This is a plain-text version of the email for non-HTML clients.';
    $mail->isHTML(true);
