		...
		<form method="post" id="create_invoice">
			...
			<div class="row">
				<div class="col-xs-12 margin-top btn-group">
					<!-- <input type="submit" id="action_create_invoice" class="btn btn-success float-right custom-btn" value="Create Invoice" data-loading-text="Creating..."> -->
					<input type="submit" id="action_create_invoice" class="btn btn-success custom-btn float-right" value="Add Product" data-loading-text="Adding...">
